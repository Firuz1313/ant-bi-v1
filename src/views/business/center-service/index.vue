...
// Mock rows (more rows for visual fullness)
const rows = ref<Row[]>([
  ...
  { fio: 'Тимуров Юсуф', dept: 'ЦО 8', total: 12, cancelled: 1, in_progress: 0, done: 11 },
  { fio: 'Нуриева Дилбар', dept: 'ЦО 9', total: 8, cancelled: 0, in_progress: 0, done: 8 }
])
